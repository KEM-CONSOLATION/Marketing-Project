    ...
    <div className="bg-black py-5 sticky z-50 top-0 transition-all duration-300 ease-in-out">
      <div className="max-w-5xl md:mx-auto mx-5 2xl:max-w-full 2xl:mx-40">
        <div className="grid md:flex justify-between items-center">
          ...
          >
            <ul className="grid md:flex gap-5 my-5 md:gap-10 list-none text-[14px] md:text-[24px]">
              <NavLink
                to="/about"
                className={({ isActive, isPending }) =>
                  isPending
                    ...
                    : isActive
                    ? "text-[14px] md:text-[24px] text-[#FCD82B] font-[700] md:text-[#FCD82B] "
                    : ""
                }
              >
                <li>About</li>
          ...
          <div className={`md:flex ${!open ? "block" : "hidden"}`}>
            <div className="w-[150px] px-2 py-2 md:px-5 md:py-4 rounded font-[500px] text-white text-center text-[14px] md:text-[24px] border-2 border-yellow-500 bg-[#000000] transition-all duration-300 ease-in-out">
              <a href="">Contact</a>
            </div>
          </div>
        </div>
