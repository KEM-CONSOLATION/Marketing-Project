      ...
      <div className=" max-w-5xl md:mx-auto mx-5 2xl:max-w-full 2xl:mx-40 text-white">
        <div className=" grid gap-2 md:flex justify-end items-start mt-10 md:mt-40">
          <div className=" font-[600]  max-w-[650px]">
            <p className=" text-[24px] md:text-[54px] px-5">
        ...
        <div className=" grid md:flex items-center py-5">
          <p className=" font-[600] font-Titillium text-[20px] w-[100px] md:text-[40px] md:w-[250px]">
            Trusted By
          </p>
      ...
      <div className="">
        ...
        <div className=" max-w-5xl md:mx-auto mx-5 2xl:max-w-full 2xl:mx-40 text-white ">
          <div className=" grid gap-5 md:flex items-start justify-between">
            <div className="">
              <p className=" font-Titillium font-[600] text-[24px] text-center md:text-left  md:text-[48px] max-w-[646px]">
            ...
            <div className="">
              <p className=" max-w-[450px] md:max-w-[500px]  text-justify text-[16px]  md:text-[24px]">
        ...
        <div className="max-w-5xl md:mx-auto mx-5 2xl:max-w-full 2xl:mx-40 text-white">
          <div className=" text-center">
            <p className=" font-[700] text-[20px] md:text-[40px]">
              Unlock the full potential of your online presence{" "}
            </p>
            <p className=" font-[400] text-[14px] md:text-[20px]">
          ...
          <div className=" grid gap-2 md:gap-0 md:grid-cols-3 py-10 text-black">
            <div className="bg-white">
              <div className="  px-20">
                ...
                <p className=" text-[24px] font-[700] pt-10 ">Digtial PR</p>
            ...
            <div className="bg-[#FFF7CF]">
              <div className="  px-20">
                <img src={Vector} alt="" className="pt-20" />
                <p className=" text-[24px] font-[700] pt-10 ">
                  Content Marketing
                </p>
                <p className=" text-[16px] font-[400] pb-10">Learn More</p>
              </div>
            ...
            <div className="bg-white">
              <div className="  px-20">
                <img src={Vector} alt="" className="pt-20" />
                <p className=" text-[24px] font-[700] pt-10 ">AI Marketing</p>
                <p className=" text-[16px] font-[400] pb-10">Learn More</p>
              </div>
            </div>
          </div>
          ...
          <div className=" py-20">
            <div className=" text-center py-20">
              ...
              <p className=" font-[400] text-[14px] md:text-[20px] max-w-[918px] mx-auto">
          ...
          <div className="">
            ...
            <div className=" grid gap-2 md:gap-0 md:grid-cols-3 py-10 text-black">
              <div className="bg-white">
                <div className="  px-20">
                  <img src={Vector} alt="" className="pt-20" />
                  <p className=" text-[24px] font-[700] py-14 ">
